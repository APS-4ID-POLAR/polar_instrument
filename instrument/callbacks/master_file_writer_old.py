...
class MyNXWriter(NXWriterAPS):
    ...
    #     # TODO: A lot of this will probably change.
    ...
    #     nxdet = self.create_NX_group(parent, "Eiger1M:NXdetector")
    #     parent["detector_1"] = nxdet  # convenience link
    #     nxdet.create_dataset("description", data="Eiger1M")  # not in metadata
    ...
    def get_ioc_file_path(self):
        import pathlib
        from instrument.devices.ad_eiger1M import IOC_FILES_ROOT
        ...
        # dir = self.metadata.get("ADIOC_FILE_DIR", IOC_FILES_ROOT)
        return pathlib.Path(IOC_FILES_ROOT)
